...
Kale was shown to, including the author. In the end \say{smart selection} was
...
\keys{0}~--~\keys{9} commands, with each command prominently displayed
...
paste command is invoked. They are also not cleared by the \say{Clear All}
button.
