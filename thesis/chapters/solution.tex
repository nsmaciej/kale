...
\medskip
\begin{figure}[h]
	\includegraphics[scale=0.35, right]{structure/literal}
\end{figure}
\noindent
\lipsum[1]
...
\medskip
\begin{figure}[h]
	\includegraphics[scale=0.35, right]{structure/variable}
\end{figure}
\noindent
\lipsum[1]
...
\begin{wrapfigure}[2]{R}{0pt}
	\includegraphics[scale=0.35]{structure/function}
\end{wrapfigure}
...
\subsection{Spaces}
\begin{wrapfigure}[2]{R}{0pt}
	\includegraphics[scale=0.35]{structure/blank}
\end{wrapfigure}
...
\begin{wrapfigure}[3]{R}{0pt}
	\includegraphics[scale=0.35]{structure/list}
\end{wrapfigure}
