...
common in contemporary languages. Lisp\cite{McCarthy1960} is a family of
languages is known for their regular syntax and homoiconicity, making Lisp the
perfect fit for Kale%
\footnote{In fact kale originally stood for Kick Ass Lisp Environment}. Each
expression within Kale belongs to one of five categories.
